...
export default function Note({ params }: { params: { id: string } }) {
  ...
  return (
    <>
      <section
        className={`flex flex-1 flex-col items-start justify-start w-full max-w-7xl h-auto min-h-max mx-auto p-4 md:pt-8 md:py-16 ${archivo.variable} transition-transform duration-300 ease-in-out`}
      >
